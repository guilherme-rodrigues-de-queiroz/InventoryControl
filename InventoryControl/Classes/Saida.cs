...
namespace InventoryControl.Classes
{
    public class Saida
    {
        ...
        private string VerificarCamposAdcSaida()
        {
        ...
        public string AdicionarSaida()
        {
            string resultado = VerificarCamposAdcSaida();
            ...
            try
            {
                ...
                string cmdInsert = "INSERT INTO SaidaProduto (Nome, Quantidade, DataAlteracao, IdProduto) " +
        ...
        {
            string cmdSelect = "SELECT IdSaidaProduto, Nome, Quantidade, DataAlteracao FROM SaidaProduto;";
        ...
        public DataTable RetornoPesquisa()
        {
            if (!string.IsNullOrEmpty(TextoPesquisa))
            {
                try
                {
                    string cmdSelect = "SELECT IdSaidaProduto, Nome, Quantidade, DataAlteracao FROM SaidaProduto WHERE Nome LIKE @Search;";
        ...
        public string ExcluirProduto()
        {
            try
            {
                string cmdDelete = "DELETE FROM SaidaProduto WHERE IdSaidaProduto = @IdSaidaProduto;";

                var parametros = new List<MySqlParameter>
                {
                    new MySqlParameter("@IdSaidaProduto", IdProduto)
                };
